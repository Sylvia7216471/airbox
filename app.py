...
def callback():
 ...
 # app.logger.info("Request body: " + body) # handle webhook body try:
 # handler.handle(body, signature) except InvalidSignatureError: abort(400)
 # return 'OK'
 # 訊息傳遞區塊
 # 基本上程式編輯都在這個function
